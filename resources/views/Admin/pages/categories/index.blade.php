        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="mb-4">
                            <form action="{{ route('dashboard.categories.search') }}" method="GET" class="d-flex gap-2"
                                novalidate>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @if (count($category->post) != 0)
                                                        <a href="{{ route('dashboard.categories.posts', $category->id) }}">
                                                            <span
                                                                class="badge bg-success my-1 fs-4 px-3 py-2 my-1">{{ count($category->post) }}</span>
                                                        </a>
                                                    @else
