    ...
    <div class="container mt-5">
        <div class="row">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled mb-0">
                            ...
                            @empty
                                <span class="badge bg-danger rounded my-1">No Skills!</span>
                            @endforelse
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-lg-8">
                ...
                <!-- User Posts -->
                <div class="card mb-4">
                    <div class="card-header">User's Posts</div>
                    <div class="card-body">
                        <!-- Check if the user has posts -->
                        @if ($user->post->isEmpty())
                            <span class="badge bg-danger rounded my-1">This user hasn't created any posts yet.</span>
                        @else
